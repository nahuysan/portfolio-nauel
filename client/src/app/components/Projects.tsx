  ...
  const projectList = [
    {
      ...
      size: "lg:col-span-2 lg:row-span-2" // Ajustado a lg para tablets
    },
    {
      id: "corchazo",
      ...
      size: "lg:col-span-2" // Ajustado a lg
    },
    {
      id: "wappa",
      ...
      size: "lg:col-span-1" // Ajustado a lg
    },
    {
      id: "python", 
  ...
  return (
    <section id="projects" className="py-24 bg-background text-foreground transition-colors duration-500">
      <div className="container mx-auto px-6">
        ...
        {/* Grid: 1 columna en mobile/tablet, 4 en desktop (desde 1024px) */}
          ...
          {projectList.map((project, index) => {
            ...
            return (
              <motion.div
                ...
                key={project.id}
                className={`${project.size} group relative bg-card border border-border/40 rounded-3xl overflow-hidden hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-[0_0_30px_rgba(var(--primary-rgb),0.1)]`}
              >
                {/* Imagen con zoom */}
